...
<script>
	$(document).ready(function() {
				...
				if (ye > 1) {
				var name = $("#name").val();
				location.href = "scores?type=manage&ye="
						+ (ye - 1)
						+ "&name="
						+ name;
				} else {
		...
		$("[name=numPage]").click(function() {
				...
				ye = $(this).html();
				//html取其中间的值
				location.href = "scores?type=manage&ye=" + ye
					 	+ "&name=" + name;
								})
						$("#add").click(function() {
							location.href = "scores?type=showAdd";
						})
								...
								.click(
										function() {
											if (selectId == 0) {
												...
												location.href = "scores?type=showModify&selectId="
														+ selectId;
											}
										})
						$("#delete")
								.click(
										function() {
											if (selectId == 0) {
												...
												location.href = "scores?type=delete&selectId="
														+ selectId;
											}
										})
					...
					<c:forEach items="${scs}" var="sc">
						...
						<tr data-id="${sc.id}">
							...
							<%-- <td><c:choose>
									...
									<c:otherwise test="${sc.score==null}">
									未录入</c:otherwise>
								</c:choose></td> --%>
						</tr>
					</c:forEach>
